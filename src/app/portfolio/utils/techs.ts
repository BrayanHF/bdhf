...
export const ANGULAR: Tech = {
  ...
  description:
    'Me encanta por RxJS y Signals, los formularios reactivos y la eficiencia de Standalone Components y Lazy Loading nativo',
};

export const TYPESCRIPT: Tech = {
  name: 'TypeScript',
  localImage: '/assets/icons/typescript.svg',
  description:
    'Soy fan del tipado, y TS me permite tener JS con esa estructura. Para mí, es lo mejor que le ha pasado a la web',
};

export const JAVASCRIPT: Tech = {
  name: 'JavaScript',
  localImage: '/assets/icons/js.svg',
  description:
    'Aprendí JS académicamente como el motor de la web, pero no lo uso mucho desde que conocí TS, lo siento JS',
};

export const CSS: Tech = {
  name: 'CSS',
  localImage: '/assets/icons/css.svg',
  description:
    'Imposible dejarlo fuera. Me da risa que me he pasado minutos decidiendo si se ve mejor con 1rem o 2rem de gap',
};

export const SCSS: Tech = {
  name: 'SCSS',
  localImage: '/assets/icons/scss.svg',
  description:
    'Me gusta mucho porque tiene toda la potencia de CSS pero mejor organizado, modular y, sobre todo, reutilizable',
};
...
export const TAILWIND: Tech = {
  ...
  description:
    'Con Tailwind todo fluye más rápido, me ahorro el tener que crear archivos de estilos para solo algunos pequeños detalles',
};

export const HTML: Tech = {
  name: 'HTML',
  localImage: '/assets/icons/html.svg',
  description:
    'Sin HTML no hay web y me es imposible olvidar aquel examen de la universidad sobre todas sus etiquetas',
};
